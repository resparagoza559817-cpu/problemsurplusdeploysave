                ...
                <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="flex space-x-8">
                        <div class="flex-1">
                            ...
                            <input type="number" name="price" step="0.01" value="{{ $product->price }}" class="w-full bg-white border-2 border-gray-400 p-3 text-xl focus:outline-none shadow-inner" style="color: #059669 !important; font-weight: bold;" required>
                        </div>
                        <div class="flex-1">
                            <label class="block text-2xl text-white mb-2 font-mono uppercase">Quantity</label>
                            <input type="number" name="stock" value="{{ $product->stock }}" class="w-full bg-white border-2 border-gray-400 p-3 text-xl focus:outline-none shadow-inner" style="color: #059669 !important; font-weight: bold;" required>
                        </div>
                    </div>

                    <div>
                        <label class="block text-2xl text-white mb-2 font-mono uppercase">Category Mapping</label>
                    ...
                    <div class="pt-4">
                        ...
                        @endif
                        <label class="block text-yellow-400 text-xs mb-2 uppercase tracking-widest">Upload New Model (Optional)</label>
                    ...
                    <div class="flex space-x-4 pt-6 border-t border-white/10">
                        ...
                        <a href="{{ route('products.index') }}" class="pixel-btn" style="background: #666;">ABORT</a>
                    </div>
                </form>
            </div>
        </div>
